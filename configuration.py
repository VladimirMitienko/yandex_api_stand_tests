...
URL_SERVICE = "https://7745d27e-883d-4103-885d-586b7c3046ae.serverhub.praktikum-services.ru"
...
# LOG_MAIN_PATH содержит путь к логу веб-сервиса.
LOG_MAIN_PATH = "/api/logs/main/"

USERS_TABLE_PATH = "/api/db/resources/user_model.csv"  # Путь к таблице пользователей
